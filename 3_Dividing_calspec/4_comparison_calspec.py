...
for order in range(0, 10, 1):
    ...
    axs[1].plot(wavelength, tanspec_flux, label='tanspec flux')
    axs[0].plot(wavelength, flux_ratio, color='green', label='ratio')
    axs[2].plot(wavelength,
                corrected_flux, color='red', label='calibrated_flux')
