...
N = 100
xmin = min(fitted_wavelength)
xmax = max(fitted_wavelength)
x = fits.getdata(file_path, ext=0)[0]

# spline fit
yvals = fitted_wavelength
...
ax1.plot(x, yvals, 'k--', label='original')
l, = ax1.plot(x, yvals, 'ro-')
