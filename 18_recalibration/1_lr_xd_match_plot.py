...
recal_lr_wl = np.load('recalibrated_wavelength.npy')
...
xd_extracted_spectra = fits.getdata(
    os.path.join(project,
                 ...
                 'op_hd37725_s0.5_grating1_A.ms.wlc.fits'), ext=0)
...
ax2.plot(recal_lr_wl, star, color='green', label='LR mode spectra')
