...
axs[2].plot(full_pixels, fitted_wls)
axs[2].plot(argon_pixels, argon, '<', label='argon')
plt.plot(neon_pixels, neon, 'o', label='neon')
axs[2].plot(sky_pixels, sky, 's', label='sky')
axs[2].plot(telluric_pixels, telluric, '*', label='telluric')
